...
class RepositoryTest {
    ...
    void aTaskCanBeAddedToCustomer() {
        ...
        Task task = new Task(UUID.randomUUID(), taskTitle, "CustomerCode", customer);
    ...
    void workLogsCanBeSearchedByUserAndDateRange() {
        ...
        WorkLog workLog1 = new WorkLog(UUID.randomUUID(), user, startDate, new Task(UUID.randomUUID(), "Task1", "CustomerCode1", new Customer()), 8);
        WorkLog workLog2 = new WorkLog(UUID.randomUUID(), user, endDate, new Task(UUID.randomUUID(), "Task2", "CustomerCode2", new Customer()), 8);
    ...
    void workLogsCanNotBeFetchByOtherUser() {
        ...
        WorkLog workLog1 = new WorkLog(UUID.randomUUID(), user1, startDate.plusDays(5), new Task(UUID.randomUUID(), "Task1", "CustomerCode1", new Customer()), 8);
        WorkLog workLog2 = new WorkLog(UUID.randomUUID(), user1, startDate.plusDays(10), new Task(UUID.randomUUID(), "Task2", "CustomerCode2", new Customer()), 8);
        workLogRepository.save(workLog1);
        workLogRepository.save(workLog2);
